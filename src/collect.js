class Collect {
    ...
    async stand(message, userId, yourcard, dealercard, DECK, options) {
        ...
        console.log("your value "+ yourvalue)
        if (options.isSplit === "first") {
            console.log("1st Split Stands")
        ...
        while (dealervalue < 17) {
            ...
            if (dealervalue > 21 && dealerrank.includes("A")) {
                ...
                console.log('Player 1st hand blackjack? ' + bj1)
                console.log('Player 2st hand blackjack? ' + bj2)
                console.log('Dealer 1st hand blackjack? ' + dbj1)
                console.log('Dealer 2nd hand blackjack? ' + dbj2)
                console.log("Player 1st hand value: "+yourvalue)
                console.log("Player 2nd hand value: "+yourvalue2)
        ...
        if (options.isSplit === "second") {
            console.log("Player 2nd hand stands.")
